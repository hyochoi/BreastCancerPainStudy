...
dmd.pvt = dmd.pvt[-which(dmd.pvt$Visits>40),]
...
x = xlist[1]
p <- ggboxplot(final.data, x=x, y="Pain",remove="Unknown",
               color = x, palette="jco")
p + stat_compare_means()

x = xlist[2]
p <- ggboxplot(cdmd.pvt, x=x, y="Pain",remove="Unknown",
               color = x, palette="jco")
p + stat_compare_means()
...
x = xlist[4]
p <- ggboxplot(cdmd.pvt, x=x, y="Pain",
               color = x, palette="jco")
p + stat_compare_means()
...
table.count <-
  ...
  add_row(,.before=9+which(grepl(pattern="lobular",rownames(table.count)))) %>%
  add_row(,.before=10+which(grepl(pattern="Central",rownames(table.count)))) %>%
  add_row(,.before=11+which(grepl(pattern="Midline",rownames(table.count)))) %>%
  add_row(,.before=12+which(grepl(pattern="HER2Positive",rownames(table.count)))) %>%
  add_row(,.before=13+which(grepl(pattern="ERPositive",rownames(table.count)))) %>%
  add_row(,.before=14+which(grepl(pattern="PRPositive",rownames(table.count))))
colnames(table.count) = c("Estimate","95% CI","P-value",
                          "Estimate","95% CI","P-value",
                          "Estimate","95% CI","P-value")
...
table.zero <-
  ...
  add_row(,.before=9+which(grepl(pattern="lobular",rownames(table.zero)))) %>%
  add_row(,.before=10+which(grepl(pattern="Central",rownames(table.zero)))) %>%
  add_row(,.before=11+which(grepl(pattern="Midline",rownames(table.zero)))) %>%
  add_row(,.before=12+which(grepl(pattern="HER2Positive",rownames(table.zero)))) %>%
  add_row(,.before=13+which(grepl(pattern="ERPositive",rownames(table.zero)))) %>%
  add_row(,.before=14+which(grepl(pattern="PRPositive",rownames(table.zero))))
colnames(table.zero) = c("Estimate","95% CI","P-value",
                          "Estimate","95% CI","P-value",
                          "Estimate","95% CI","P-value")
